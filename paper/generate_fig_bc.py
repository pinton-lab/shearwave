#!/usr/bin/env python3
"""Generate combined acoustical maps + pressure + ARF figure from saved data.

Layout (3 rows × 3 cols):
  Row 0: Sound speed | Density | Attenuation (full-res XY slices)
  Row 1: Pressure t1 | Pressure t2 | Pressure t3 (downsampled XY)
...
t_indices = [100, nt // 2, 400]
t_indices = [min(t, nt - 1) for t in t_indices]
print(f"Pressure snapshot indices: {t_indices}")
...
# --- Save ---
out_path = out_dir / "fig_bcd_medium_pressure_arf.png"
